                            ...
                            <form action="<?= APP_URL; ?>/app/controllers/profesores/update_subjects.php" method="post">
                                ...
                                <div class="row" style="margin-top:20px;">
                                    <div class="col-md-12">
                                        ...
                                        <a href="<?= APP_URL; ?>/admin/configuraciones/eliminar_materias_profesor" class="btn btn-secondary">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script src="../../app/controllers/js/delete_subjects.js"></script>
