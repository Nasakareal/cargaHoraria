...
include('../../app/controllers/alumnos/datos_de_alumnos.php');
...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <h1>Alumno: <?= htmlspecialchars($alumno_nombre); ?></h1> 
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <p><?= htmlspecialchars($alumno_nombre); ?></p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <p><?= htmlspecialchars($selected_term_id); ?></p> 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <a href="<?= APP_URL; ?>/admin/alumnos" class="btn btn-secondary">Volver</a>
                                    </div>
                                </div>
                            </div>
                        </div>
