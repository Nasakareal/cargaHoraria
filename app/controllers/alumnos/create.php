...
$student_name = trim($_POST['student_name']);  // Asegúrate que el nombre del campo en el formulario es 'nombre_estudiante'
$program_id = $_POST['program_id'];                // Asegúrate que el nombre del campo en el formulario es 'programa_id'
$term_id = $_POST['term_id'];               // Asegúrate que el nombre del campo en el formulario es 'cuatrimestre_id'
$group_id = $_POST['group_id'];                     // Asegúrate que el nombre del campo en el formulario es 'grupo_id'
